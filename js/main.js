...
jQuery(document).ready(function($) {
    ...
    (function updateCurrentWeather()
    {
        ...
        $.getJSON('http://api.openweathermap.org/data/2.5/weather', weatherParams, function(json, textStatus) {
            ...
            $('.temp').updateWithText(windString + ' ' + icon.outerHTML()+temp+'&deg;', 1000);
            ...
            var locationString = '<span class="location">'+location+'</span>';


            var sunriseString = '<span class="wi wi-sunrise xdimmed"></span> ' + sunrise;
            var sunsetString = '<span class="wi wi-sunset xdimmed"></span> ' + sunset;
            //siempre sunrise y sunset
            /* si ya ha pasado el sunrise no se muestra
            if (json.sys.sunrise*1000 < now && json.sys.sunset*1000 > now) {
                sunString = '<span class="wi wi-sunset xdimmed"></span> ' + sunset;
            }
            */

            $('.windsun').updateWithText( locationString+' '+sunriseString+' '+sunsetString, 1000);
        });
